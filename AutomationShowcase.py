...
LR_INCREMENT = 0.0001  # wird dynamisch ersetzt
LOG_DIR = os.path.join(WORK_DIR, r"config\Automation\ConfigLog")
LOG_FILE_PATH = os.path.join(LOG_DIR, RUN_ID + "Log.txt")

#CONFIG_FILE = os.path.join(WORK_DIR, r"config\Automation\Config5LSAutoGPUV2.yaml")
...
def main():
    ...
    for _ in range(0, MAX_TOTAL_STEPS, STEP_INCREMENT):
        ...
        if not first_run:
            ...
            print(f"▶️ Erster Trainingslauf mit max_steps={prev_steps}")
